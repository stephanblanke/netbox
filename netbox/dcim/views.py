...
from ipam.models import ASN, IPAddress, FHRPGroup, Prefix, Service, VLAN
...
class SiteView(generic.ObjectView):
    ...
    def get_extra_context(self, request, instance):
        stats = {
            ...
            'fhrpgroup_count': FHRPGroup.objects.restrict(request.user, 'view').filter(site=instance).count(),
